...
ISR (ADC_vect)
  {
    ...
    if(resultNumber >= 51)
    {
    results2 [resultNumber-51] = analogRead (1);
    }
    resultNumber++;
...
//  Serial.println ("ok\n\n\n\n\n\n\n");
  ...
  int constantleft=result_max-result_min;
  int constantright=result2_max-result2_min;
  //Serial.println (constantleft);
  //Serial.println (constantright);
  if (constantleft >=15 && constantright >= 15)
  {
